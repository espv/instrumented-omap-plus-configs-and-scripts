...
void set_task_cpu(struct task_struct *p, unsigned int new_cpu)
{
    ...
    // This is apparently not the only place where the cpu of the task can be
    // set, moved this call to the __set_task_cpu function.
...
try_to_wake_up(struct task_struct *p, unsigned int state, int wake_flags)
{
    ...
    trace_sepext_wakeup(__builtin_return_address(0), p);
	       ...
	       struct task_struct *next)
{
    ...
    // OYSTEDAL
	trace_sepext_ctxswitch(prev, next);
...
need_resched:
	...
	if (prev->state && !(preempt_count() & PREEMPT_ACTIVE)) {
		if (unlikely(signal_pending_state(prev->state, prev))) {
            ...
            // trace_sepext_dequeuerq(__builtin_return_address(0), prev, DEQUEUE_SLEEP);
...
void complete(struct completion *x)
{
    ...
    // OYSTEDAL
    trace_sepext_complete(__builtin_return_address(0), x, STATE_GLOBAL);
...
void complete_all(struct completion *x)
{
    ...
    // OYSTEDAL
    trace_sepext_complete_all(__builtin_return_address(0), x, STATE_GLOBAL);
...
{
    // OYSTEDAL
    trace_sepext_wait_for_completion(__builtin_return_address(0), x, STATE_GLOBAL);
...
{
    // OYSTEDAL
    trace_sepext_wait_for_completion_timeout(__builtin_return_address(0), x, timeout, STATE_GLOBAL);
...
{
    // OYSTEDAL
    trace_sepext_wait_for_completion_interruptible(__builtin_return_address(0), x, STATE_GLOBAL);
...
{
    // OYSTEDAL
    trace_sepext_wait_for_completion_interruptible_timeout(__builtin_return_address(0), x, timeout, STATE_GLOBAL);
...
{
    // OYSTEDAL
    trace_sepext_wait_for_completion_killable(__builtin_return_address(0), x, STATE_GLOBAL);
...
{
    // OYSTEDAL
    trace_sepext_wait_for_completion_killable_timeout(__builtin_return_address(0), x, timeout, STATE_GLOBAL);
...
bool try_wait_for_completion(struct completion *x)
{
    ...
    // OYSTEDAL
    trace_sepext_try_wait_for_completion(__builtin_return_address(0), x, STATE_GLOBAL);
